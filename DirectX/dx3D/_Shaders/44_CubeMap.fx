...
technique11 T0
{
    ...
    //Depth
    P_RS_VP(P1, FrontCounterCloskwise_True, VS_Depth_Mesh, PS_Depth)
    P_RS_VP(P2, FrontCounterCloskwise_True, VS_Depth_Model, PS_Depth)
    P_RS_VP(P3, FrontCounterCloskwise_True, VS_Depth_Animation, PS_Depth)
    ...
    //Cube PreRender
    P_RS_DSS_VGP(P7, FrontCounterCloskwise_True, DepthEnable_False, VS_Mesh, GS_PreRender, PS_SkyPreRender)
