...
public class StoveController : MonoBehaviour
{
	...
	// 5 는 널값
	public static int PotPrimaryKey = 5;
	...
	void Update()
	{
		...
		else if (Input.GetMouseButtonUp(0) && moveCheck && Singtone.Instance.count < 6)
		{
			...
			PotPrimaryKey = 5;
			PotRect[0].localPosition = new Vector3(2.9f, -33, 0);
			PotRect[1].localPosition = new Vector3(2.9f, -33, 0);
			PotRect[2].localPosition = new Vector3(2.9f, -33, 0);
		}
